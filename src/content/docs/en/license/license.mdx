...
Yabe Heikou's license system is an additional layer on top of Oxygen's Design Library system. It serves as a thin middleware that allows the use of Yabe Heikou's license system as a Site Key to access the design set on the current WordPress installation. 

## Adding a license

### Step 1: Add new license

Go to **Oxygen → Yabe Heikou** and click the **Add New** button.

<a data-fslightbox href="/tutorial/license/license/1.png">
![Add new license to yabe heikou](/tutorial/license/license/1.png)
</a>
